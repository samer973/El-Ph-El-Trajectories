function val = nearnearpsi2v2(s1,s2,s3,t1,t2,t3,alpha1,alpha2,alpha3,omega,theta1,theta2,theta3,phi) 
...
int1_ppp = -1*1i*omega/2*(ppmterm.*(gaussian(s1+t1,alpha1,mup)).*(gaussian(s2+t2,alpha2,mue1)).*(gaussint(s1+t1,s3+t3,alpha3,mue2)));
int1_pmp = -1*1i*omega/2*(pmmterm.*(gaussian(s1+t1,alpha1,mup)).*(gaussian(s2-t2,alpha2,mue1)).*(gaussint(s1+t1,s3+t3,alpha3,mue2)));
...
int1_ppm = -1*1i*omega/2.*exp(1i .* phi).*(mmpterm.*(gaussian(s3-t3,alpha1,mup)).*(gaussint(s2-t2,s2+t2,alpha2,mue1)).*(gaussian(s1+t1,alpha3,mue2)));
int1_pmm = -1*1i*omega/2.*exp(1i .* phi).*(mppterm.*(gaussian(s3-t3,alpha1,mup)).*(gaussint(s2-t2,s2+t2,alpha2,mue1)).*(gaussian(s1+t1,alpha3,mue2)));
...
int2_ppm = -1*1i*omega/2.*exp(1i * phi)*(mpmterm.*(gaussian(s3-t3,alpha1,mup)).*(gaussian(s2+t2,alpha2,mue1)).*(gaussint(s3-t3,s1+t1,alpha3,mue2)));
int2_pmm = -1*1i*omega/2.*exp(1i * phi)*(mmmterm.*(gaussian(s3-t3,alpha1,mup)).*(gaussian(s2-t2,alpha2,mue1)).*(gaussint(s3-t3,s1+t1,alpha3,mue2)));
...
int3_ppp = -1*1i*omega/2.*(pmpterm.*(gaussian(s1+t1,alpha1,mup)).*(gaussint(s2-t2,s2+t2,alpha2,mue1)).*(gaussian(s3+t3,alpha3,mue2)));
int3_pmp = -1*1i*omega/2.*(pppterm.*(gaussian(s1+t1,alpha1,mup)).*(gaussint(s2-t2,s2+t2,alpha2,mue1)).*(gaussian(s3+t3,alpha3,mue2)));
...
int3_ppm = -1*1i*omega/2.*(pppterm.*(gaussian(s1+t1,alpha1,mup)).*(gaussian(s2+t2,alpha2,mue1)).*(gaussint(s1+t1,s3+t3,alpha3,mue2)));
int3_pmm = -1*1i*omega/2.*(pmpterm.*(gaussian(s1+t1,alpha1,mup)).*(gaussian(s2-t2,alpha2,mue1)).*(gaussint(s1+t1,s3+t3,alpha3,mue2)));
