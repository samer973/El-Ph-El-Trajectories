function val = psiArbiterv2(s1,s2,s3,t1,t2,t3,alpha1,alpha2,alpha3,omega,theta1,theta2,theta3,phi) 
...
% end
if(s1-t1 < s2+t2)
        val_mpp = subsref(nearnearpsi1v2(s1,s2,s3,t1,t2,t3,alpha1,alpha2,alpha3,omega,theta1,theta2,theta3,phi), struct('type', '()', 'subs', {{1}}));
        val_mpm = subsref(nearnearpsi1v2(s1,s2,s3,t1,t2,t3,alpha1,alpha2,alpha3,omega,theta1,theta2,theta3,phi), struct('type', '()', 'subs', {{2}}));
        val_mmp = subsref(nearnearpsi1v2(s1,s2,s3,t1,t2,t3,alpha1,alpha2,alpha3,omega,theta1,theta2,theta3,phi), struct('type', '()', 'subs', {{3}}));
        val_mmm = subsref(nearnearpsi1v2(s1,s2,s3,t1,t2,t3,alpha1,alpha2,alpha3,omega,theta1,theta2,theta3,phi), struct('type', '()', 'subs', {{4}}));
else
...
if(s1+t1 > s3-t3)
        val_ppm = subsref(nearnearpsi2v2(s1,s2,s3,t1,t2,t3,alpha1,alpha2,alpha3,omega,theta1,theta2,theta3,phi), struct('type', '()', 'subs', {{2}}));
        val_pmm = subsref(nearnearpsi2v2(s1,s2,s3,t1,t2,t3,alpha1,alpha2,alpha3,omega,theta1,theta2,theta3,phi), struct('type', '()', 'subs', {{4}}));
        val_ppp = subsref(nearnearpsi2v2(s1,s2,s3,t1,t2,t3,alpha1,alpha2,alpha3,omega,theta1,theta2,theta3,phi), struct('type', '()', 'subs', {{1}}));
        val_pmp = subsref(nearnearpsi2v2(s1,s2,s3,t1,t2,t3,alpha1,alpha2,alpha3,omega,theta1,theta2,theta3,phi), struct('type', '()', 'subs', {{3}}));
else
