function val = nearnearpsi1v2(s1,s2,s3,t1,t2,t3,alpha1,alpha2,alpha3,omega,theta1,theta2,theta3,phi) 
...
int1_mpp = -1*1i*omega/2.*exp(1i .* phi).*(pmmterm.*(gaussian(s2+t2,alpha1,mup)).*(gaussian(s1-t1,alpha2,mue1)).*(gaussint(s2-t2,s2+t2,alpha3,mue2)));
int1_mpm = -1*1i*omega/2.*exp(1i .* phi).*(pmpterm.*(gaussian(s2+t2,alpha1,mup)).*(gaussian(s1-t1,alpha2,mue1)).*(gaussint(s2-t2,s2+t2,alpha3,mue2)));
...
%int2_mpm = -1*1i*omega/2*integral(@(sigma) exp(1i * phi)*psi0_ppm(s2+t2,sigma,t3-t3,theta1,theta2,theta3,alpha1,alpha2,alpha3),s1-t2,s2+t2);

int2_mpp = -1*1i*omega/2.*exp(1i * phi).*(pppterm.*(gaussian(s2+t2,alpha1,mup)).*(gaussint(s1-t1,s2+t2,alpha2,mue1)).*(gaussian(s3+t3,alpha3,mue2)));
int2_mpm = -1*1i*omega/2.*exp(1i * phi).*(ppmterm.*(gaussian(s2+t2,alpha1,mup)).*(gaussint(s1-t1,s2+t2,alpha2,mue1)).*(gaussian(s3-t3,alpha3,mue2)));
...
int2_mmp = -1*1i*omega.*exp(1i * phi).*(pmpterm.*(annoygaussint1(s1,t1,s2,t2,alpha1,mup)).*(gaussian(s1-t1,alpha2,mue1)).*(gaussian(s3+t3,alpha3,mue2)));
...
%int3_mmp = -1*1i*omega/2*integral(@(tau) psi0_mmm(s1-t1,s2-t2,tau,theta1,theta2,theta3,alpha1,alpha2,alpha3),s3-t3,s3+t2);
%int3_mmm = -1*1i*omega/2*integral(@(tau) psi0_mmp(s1-t1,s2-t2,tau,theta1,theta2,theta3,alpha1,alpha2,alpha3),s3-t3,s3+t2);

int3_mmp = -1*1i*omega/2.*(mmmterm.*(gaussian(s1-t1,alpha1,mup)).*(gaussian(s2-t2,alpha2,mue1)).*(gaussint(s3-t3,s3+t3,alpha3,mue2)));
int3_mmm = -1*1i*omega/2.*(mmpterm.*(gaussian(s1-t1,alpha1,mup)).*(gaussian(s2-t2,alpha2,mue1)).*(gaussint(s3-t3,s3+t3,alpha3,mue2)));
